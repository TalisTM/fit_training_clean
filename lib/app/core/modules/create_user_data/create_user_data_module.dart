...
import 'package:fit_training_clean/app/core/modules/create_user_data/external/datasources/firebase_firestore_datasource.dart';
...
class CreateUserDataModule extends Module {
  ...
  List<Bind<Object>> get binds => [
        ...
        Bind((i) => FirebaseFirestoreUserDatasource(firestore: i()), export: true),
      ];
}
